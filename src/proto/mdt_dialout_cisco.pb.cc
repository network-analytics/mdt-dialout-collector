...
static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_mdt_5fdialout_5fcisco_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_mdt_5fdialout_5fcisco_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_mdt_5fdialout_5fcisco_2eproto = nullptr;

const uint32_t TableStruct_mdt_5fdialout_5fcisco_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::mdt_dialout::MdtDialoutArgs, totalsize_),
};
...
const char descriptor_table_protodef_mdt_5fdialout_5fcisco_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\027mdt_dialout_cisco.proto\022\013mdt_dialout\"P"
  "\n\016MdtDialoutArgs\022\r\n\005ReqId\030\001 \001(\003\022\014\n\004data\030"
  "\002 \001(\014\022\016\n\006errors\030\003 \001(\t\022\021\n\ttotalSize\030\004 \001(\005"
  "2^\n\016gRPCMdtDialout\022L\n\nMdtDialout\022\033.mdt_d"
  "ialout.MdtDialoutArgs\032\033.mdt_dialout.MdtD"
  "ialoutArgs\"\000(\0010\001b\006proto3"
  ;
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_mdt_5fdialout_5fcisco_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_mdt_5fdialout_5fcisco_2eproto = {
  false, false, 224, descriptor_table_protodef_mdt_5fdialout_5fcisco_2eproto, "mdt_dialout_cisco.proto", 
  &descriptor_table_mdt_5fdialout_5fcisco_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_mdt_5fdialout_5fcisco_2eproto::offsets,
  file_level_metadata_mdt_5fdialout_5fcisco_2eproto, file_level_enum_descriptors_mdt_5fdialout_5fcisco_2eproto, file_level_service_descriptors_mdt_5fdialout_5fcisco_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* descriptor_table_mdt_5fdialout_5fcisco_2eproto_getter() {
  return &descriptor_table_mdt_5fdialout_5fcisco_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_mdt_5fdialout_5fcisco_2eproto(&descriptor_table_mdt_5fdialout_5fcisco_2eproto);
namespace mdt_dialout {
...
MdtDialoutArgs::MdtDialoutArgs(const MdtDialoutArgs& from)
  ...
  ::memcpy(&reqid_, &from.reqid_,
    ...
    reinterpret_cast<char*>(&reqid_)) + sizeof(totalsize_));
...
uint8_t* MdtDialoutArgs::_InternalSerialize(
  ...
  if (this->_internal_totalsize() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(4, this->_internal_totalsize(), target);
  }
...
void MdtDialoutArgs::InternalSwap(MdtDialoutArgs* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(MdtDialoutArgs, totalsize_)
      + sizeof(MdtDialoutArgs::totalsize_)
      - PROTOBUF_FIELD_OFFSET(MdtDialoutArgs, reqid_)>(
...
::PROTOBUF_NAMESPACE_ID::Metadata MdtDialoutArgs::GetMetadata() const {
  return ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(
      &descriptor_table_mdt_5fdialout_5fcisco_2eproto_getter, &descriptor_table_mdt_5fdialout_5fcisco_2eproto_once,
      file_level_metadata_mdt_5fdialout_5fcisco_2eproto[0]);
}
